...
export default function ProjectUpdateForm(props) {
  ...
  const [database, setDatabase] = React.useState(initialValues.database);
  ...
  const resetStateValues = () => {
    ...
    setDatabase(cleanValues.database);
    setErrors({});
  };
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.database ?? value;
          }
          if (errors.database?.hasError) {
            runValidationTasks("database", value);
          }
          setDatabase(value);
        }}
        onBlur={() => runValidationTasks("database", database)}
        errorMessage={errors.database?.errorMessage}
        hasError={errors.database?.hasError}
